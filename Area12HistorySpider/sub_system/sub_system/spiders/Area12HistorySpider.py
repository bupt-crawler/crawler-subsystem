...
class Area12historyspiderSpider(scrapy.Spider):
    name = 'Area12HistorySpider'
    allowed_domains = ['gprs.sj2000.org']
    start_urls = ['http://gprs.sj2000.org/Web/TDDataManage.aspx?type=2&EquipmentID=2864']
    custom_settings = {
        'ITEM_PIPELINES': {
    ...
    timeName = "Area12HistoryTime"  # 时间字典中的key
