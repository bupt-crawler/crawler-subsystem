...
class Area16historyspiderSpider(scrapy.Spider):
    name = 'Area16HistorySpider'
    allowed_domains = ['gprs.sj2000.org']
    start_urls = ['http://gprs.sj2000.org/Web/TDDataManage.aspx?type=2&EquipmentID=2862']
    custom_settings = {
        'ITEM_PIPELINES': {
    ...
    timeName = "Area16HistoryTime"  # 时间字典中的key
