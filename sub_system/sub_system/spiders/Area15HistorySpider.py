...
class Area15historyspiderSpider(scrapy.Spider):
    name = 'Area15HistorySpider'
    allowed_domains = ['gprs.sj2000.org']
    start_urls = ['http://gprs.sj2000.org/Web/TDDataManage.aspx?type=2&EquipmentID=2860']
    custom_settings = {
        'ITEM_PIPELINES': {
    ...
    timeName = "Area15HistoryTime"  # 时间字典中的key
