...
class Area14historyspiderSpider(scrapy.Spider):
    name = 'Area14HistorySpider'
    allowed_domains = ['gprs.sj2000.org']
    start_urls = ['http://gprs.sj2000.org/Web/TDDataManage.aspx?type=2&EquipmentID=2861']
    custom_settings = {
        'ITEM_PIPELINES': {
    ...
    timeName = "Area14HistoryTime"  # 时间字典中的key
