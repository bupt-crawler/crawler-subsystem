...
class Area17historyspiderSpider(scrapy.Spider):
    name = 'Area17HistorySpider'
    allowed_domains = ['gprs.sj2000.org']
    start_urls = ['http://gprs.sj2000.org/Web/TDDataManage.aspx?type=2&EquipmentID=2418']
    custom_settings = {
        'ITEM_PIPELINES': {
    ...
    timeName = "Area17HistoryTime"  # 时间字典中的key
